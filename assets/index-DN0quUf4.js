...
const CheckCheck = createLucideIcon("CheckCheck", __iconNode$a);
/**
 * @license lucide-react v0.479.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const CircleCheckBig = createLucideIcon("CircleCheckBig", __iconNode$8);
/**
 * @license lucide-react v0.479.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function HeroSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "w-screen min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-950 via-indigo-900 to-purple-900 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-6 left-6 flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "h-6 w-6 text-blue-400" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-400 font-medium text-lg", children: "verifier" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl md:text-6xl font-bold text-white mb-4 tracking-tight", children: [
        "Email Checker",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300", children: "and Verifier" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-300 mb-8", children: "Reduce bounce rate and improve your email marketing performance with our verifier." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center bg-white/10 px-4 py-2 rounded-full shadow-md w-full max-w-lg mx-auto backdrop-blur-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg", children: "Verify" })
      ] })
    ] })
  ] });
}
const company1 = "/Brandnav/assets/company1-BpM04fR4.png";
const company2 = "/Brandnav/assets/company2-BlTZcvXa.png";
const company3 = "/Brandnav/assets/company3-udMgoqgd.png";
const company4 = "data:image/png;base64,";
const company5 = "/Brandnav/assets/company5-B0lNHnku.png";
function TrustedBySection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-indigo-950 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-col items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl md:text-3xl font-medium mb-8 text-center", children: [
      "Modern companies are using ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-white", children: "Verifier" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-[90%] max-w-[1100px] flex justify-between items-center gap-6 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: company1, alt: "Sentry Ecom", className: "h-10 md:h-12 opacity-90" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: company2, alt: "XLR Media", className: "h-10 md:h-12 opacity-90" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: company3, alt: "Outreach Clerk", className: "h-10 md:h-12 opacity-90" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: company4, alt: "OG", className: "h-10 md:h-12 opacity-90" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: company5, alt: "ACEXMEDIA", className: "h-10 md:h-12 opacity-90" })
    ] })
  ] }) });
}
const image0 = "/Brandnav/assets/image0-R_muLWMm.png";
const image1 = "/Brandnav/assets/image1-j8uXQnVA.png";
const image2 = "/Brandnav/assets/image2-DFRMR_VI.png";
function HowItWorks() {
  const steps = [
    {
      icon: image0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-gradient-to-b from-indigo-950 to-indigo-900 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold text-center mb-4", children: "How it works" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-gray-300 mb-12", children: "It's super easy to verify your email addresses with Verifier." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-16", children: steps.map((step, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-indigo-100 p-0 rounded-2xl mb-6 shadow-md flex items-center justify-center w-24 h-24 overflow-hidden transition-transform transform hover:scale-105", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: step.icon,
          alt: step.title,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 max-w-xs", children: step.description })
    ] }, index)) })
  ] }) });
}
function EmailVerifierSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-[#0A0E22] text-white py-20 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-indigo-900/30 to-transparent opacity-70" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-indigo-900/10 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-blue-400 rounded-full animate-pulse" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center rotate-45", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-[1px] bg-blue-400/30" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center -rotate-45", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-[1px] bg-blue-400/30" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center rotate-90", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-[1px] bg-blue-400/30" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center rotate-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-[1px] bg-blue-400/30" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-5xl font-bold mb-4 tracking-tight", children: [
          "World's most accurate email ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden md:block" }),
          "verifier and validator online"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-lg", children: "Clean and validate your email addresses in just one click" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "text-blue-400", size: 22 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Bulk email verifier" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-3", children: "Verify your email lists effortlessly" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mb-6", children: "Use the bulk email verifier to improve email deliverability and sender reputation." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-green-500 flex-shrink-0 mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Remove wrong emails" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-green-500 flex-shrink-0 mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Avoid spam traps" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-green-500 flex-shrink-0 mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Reduce bounces" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-indigo-600 hover:bg-indigo-700 transition-all duration-300 py-3 px-8 rounded-md text-white text-lg font-medium tracking-wide", children: "Dive In!" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#131A35] p-6 rounded-2xl border border-blue-500/20 shadow-[0_0_30px_rgba(59,130,246,0.15)] relative overflow-hidden backdrop-blur-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-gray-300 font-medium", children: "Total Leads" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold", children: "5,689" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mb-1", children: "+10% from last week" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1 bg-gray-700 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-[70%] rounded-full bg-gradient-to-r from-green-400 to-green-500" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-center mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 rounded-full bg-green-500" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-400", children: "70% Deliverable" })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 border-b border-gray-700/50", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-orange-400 flex items-center justify-center text-xs font-medium", children: "M" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Maria Hill" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-green-500" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Deliverable" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 border-b border-gray-700/50", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-blue-400 flex items-center justify-center text-xs font-medium", children: "S" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Steve Porter" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-green-500" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Deliverable" })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 border-b border-gray-700/50", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-purple-400 flex items-center justify-center text-xs font-medium", children: "E" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Emma Grant" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-red-500" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Non-deliverable" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", ref: avatarRef, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex -space-x-2", children: ["bg-blue-400", "bg-green-400", "bg-yellow-400", "bg-purple-400", "bg-red-400"].map((color, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-7 h-7 rounded-full ${color} avatar-dot transition-opacity duration-1000 flex items-center justify-center text-xs`, children: String.fromCharCode(65 + i) }, i)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-gray-700 ml-1 flex items-center justify-center text-xs", children: "+9" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-20 -right-20 w-40 h-40 bg-green-500/20 rounded-full blur-3xl" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-20 -left-20 w-40 h-40 bg-blue-500/20 rounded-full blur-3xl" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-16 mt-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#131A35] p-6 pt-10 rounded-2xl border border-blue-500/20 shadow-[0_0_30px_rgba(59,130,246,0.15)] relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -top-6 left-6 flex space-x-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-[#F7DF1E] text-black font-bold text-sm flex items-center justify-center rounded-full shadow-lg", children: "JS" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-[#3776AB] text-white font-bold text-sm flex items-center justify-center rounded-full shadow-lg", children: "PY" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-[#777BB4] text-white font-bold text-sm flex items-center justify-center rounded-full shadow-lg", children: "PHP" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#0D1125] rounded-lg p-4 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("code", { children: [
            "fetch(",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-300", children: "'https://api.example.com'" }),
            ")\n  ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-300", children: "then" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "(" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-300", children: "response" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: " => " }),
            "  ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-300", children: "response" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: ".json())" }),
            "\n  ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-300", children: "then" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "(" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-300", children: "data" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: " => " }),
            "  ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-300", children: "console" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-300", children: "log" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "(" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-300", children: "data" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "));" })
          ] }) }) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "text-blue-400", size: 22 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Email Verification API" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-3", children: "Prevent inaccurate data with real-time email validation" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mb-6", children: "Guard your system against inaccurate data by instantly filtering out invalid addresses." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-green-500 flex-shrink-0 mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Elegant and secure HTTPS-based RESTful API, with JSON response format" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-green-500 flex-shrink-0 mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Verification filters for every your database entry" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-green-500 flex-shrink-0 mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Integrate the Verifier's real-time API into your website's registration process" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-indigo-600 hover:bg-indigo-700 transition-all duration-300 py-3 px-8 rounded-md text-white text-lg font-medium tracking-wide", children: "Dive In!" })
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 border border-blue-500/30 pointer-events-none" })
  ] });
}
const features = [
  ...
  { icon: CircleAlert, title: "SMTP provider identification", description: "Automatically identify the email provider for targeted outreach" },
...
const FeatureCard = ({ icon: Icon2, title, description }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#12162E] p-5 rounded-lg shadow-md flex flex-col items-start text-left", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 32, className: "text-blue-400" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-3 text-lg font-semibold", children: title }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mt-1", children: description })
] });
const Features = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[#0A0E22] text-white py-16 px-4 relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto relative z-10 flex flex-col md:flex-row items-start gap-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:w-1/3 flex flex-col items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold leading-tight", children: "Rock solid email verification" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mt-3", children: "Clean, optimize, and supercharge your email lists." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mt-5 bg-blue-500 px-6 py-2 rounded-lg text-white", children: "Dive in!" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: features.map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureCard, { ...feature }, index)) })
  ] }) });
};
const Pricingcomponent = () => {
  const [emailCount, setEmailCount] = reactExports.useState(2e3);
  const pricePerMonth = emailCount / 1e3 * 9;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-[#0A0E22] text-white w-full flex flex-col items-center py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1020px] w-full text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold", children: "Choose the right plan for you" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mt-2", children: "With great power comes great plans" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1020px] w-full flex flex-col md:flex-row justify-between mt-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#12162E] p-6 rounded-lg shadow-md w-[48%] flex flex-col items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-gray-400", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "Monthly" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "toggle-checkbox" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Pay-as-you-go" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4", children: "How many emails do you have?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-2xl font-bold mt-4", children: [
          "$",
          pricePerMonth.toFixed(2),
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "USD/month" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mt-4 bg-blue-500 px-6 py-2 rounded-lg text-white", children: "Buy this now" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#12162E] p-6 rounded-lg shadow-md w-[48%]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-center", children: "Monthly rates" }),
        ...
        ].map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between px-4 py-2 border-b border-gray-700", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: item.emails }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: item.price })
        ] }, index)) })
      ] })
    ] })
  ] });
...
function BiMicrophone(props) {
  return GenIcon({ "attr": { "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "M16 12V6c0-2.217-1.785-4.021-3.979-4.021a.933.933 0 0 0-.209.025A4.006 4.006 0 0 0 8 6v6c0 2.206 1.794 4 4 4s4-1.794 4-4zm-6 0V6c0-1.103.897-2 2-2a.89.89 0 0 0 .163-.015C13.188 4.06 14 4.935 14 6v6c0 1.103-.897 2-2 2s-2-.897-2-2z" }, "child": [] }, { "tag": "path", "attr": { "d": "M6 12H4c0 4.072 3.061 7.436 7 7.931V22h2v-2.069c3.939-.495 7-3.858 7-7.931h-2c0 3.309-2.691 6-6 6s-6-2.691-6-6z" }, "child": [] }] })(props);
}
const Verifier = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[750px] bg-[#0d0d1a] p-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white text-4xl font-semibold mb-12", children: "Who is using Verifier?" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-blue-400 p-16 rounded-lg w-full max-w-[95%] mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#101020] p-8 rounded-lg flex flex-col justify-center items-center w-full h-[190px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FaUsers, { className: "text-4xl text-white mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-center text-lg", children: "Sales and marketing teams" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#101020] p-8 rounded-lg flex flex-col justify-center items-center w-full h-[190px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FaLaptop, { className: "text-4xl text-white mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-center text-lg", children: "Software & IT companies" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#151525] p-10 rounded-lg flex flex-col justify-center items-center w-full h-[380px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-xl text-center", children: "Irreplaceable tool for businesses" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaBriefcase, { className: "text-5xl text-white mt-6" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white mt-4 text-lg", children: "Service providers" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#101020] p-8 rounded-lg flex flex-col justify-center items-center w-full h-[190px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(BiMicrophone, { className: "text-4xl text-white mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-center text-lg", children: "Recruiters" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#101020] p-8 rounded-lg flex flex-col justify-center items-center w-full h-[190px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FaLink, { className: "text-4xl text-white mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-center text-lg", children: "Backlinks outreach" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-10 rounded-lg shadow-md text-lg", children: "Dive in!" }) })
    ] })
  ] });
};
const FAQ = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-[#0d0d1a] py-20 px-10 w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white text-5xl font-semibold mb-12", children: "Frequently Asked Questions" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-[1000px]", children: faqs.map((faq, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            faq.question,
            openIndex === index ? /* @__PURE__ */ jsxRuntimeExports.jsx(FaChevronUp, { className: "text-white" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FaChevronDown, { className: "text-white" })
          ]
        }
      ),
      openIndex === index && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#29293a] p-6 text-white text-md rounded-2xl mt-2 shadow-md", children: faq.answer })
    ] }, index)) })
  ] });
};
const Calltoaction = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-b from-[#0d0d1a] to-[#1a1a2e] text-center py-28 px-6 w-full min-h-screen flex flex-col justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white text-6xl font-bold", children: "TrySee Verifier" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-gray-300 text-4xl mt-3", children: "in action" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mt-8 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white text-lg font-semibold py-3 px-10 rounded-lg shadow-md", children: "Dive in!" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#0b0b16] w-full py-8 px-12 text-gray-400 text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 items-center md:items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-blue-500 font-bold text-lg", children: "✔ verifier" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "2024 Verifier. All rights reserved." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-xs text-center md:text-left", children: [
          "All trademarks, logos, and brand names are the property of their respective owners. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "The use of these names, logos, and brands does not imply endorsement."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8 mt-6 md:mt-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-white", children: "Terms and conditions" }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TrustedBySection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HowItWorks, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(EmailVerifierSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Features, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pricingcomponent, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Verifier, {}),
